function yi = interp1qr_bound(x,y,xi)
...
% Returns y(1) and y(end) resp. for values of 'xi' out of range of 'x'. 
% Returns NaN is 'xi' is NaN.
%
...
% (modified by PH for 'bounded' behaviour)
...
%
% Unlike 'interp1q', this function returns the first/last value of y for any values of 'xi' that
% lie outside the coordinates in 'x'. It returns NaN when 'xi' is NaN.
%
